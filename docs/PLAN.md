...
**23 validées — 1 en tests techniques — 1 à revalider — 7 implémentées — 10 à créer**
...
| `feat/admin`             | 🔄 En cours  | Back-office complet validé : dashboard (CA N/N-1/30j), vins CRUD (traduction EN auto/readonly), commandes (per_page, filtre paiement, facture PDF sécurisée), comptes, tarifs, actualités, newsletter — icônes SVG nav, favicon doré, fix EXTR_SKIP $status |
