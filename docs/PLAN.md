...
| `News-Management.php` | `src/View/admin/news/` — CRUD articles bilingues, slug figé à la création | 🔄 Implémenté |
| `Newsletter-Management.php` | `src/View/admin/newsletter/index.php` — liste abonnés, envoi via modal | 🔄 Implémenté |
...
| `feat/admin`             | 🔄 En cours  | Back-office : dashboard, vins CRUD, commandes, comptes, tarifs, actualités, newsletter — UX round 5 en cours |
