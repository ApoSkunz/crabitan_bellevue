...
| `feat/ci`              | A faire     | Pipeline GitHub Actions : PHPUnit (TU+TI) + Playwright (E2E) + TruffleHog + Legitify |
...
| `feat/order`           | A faire     | Checkout, paiement CA API, facture TCPDF, email                |
