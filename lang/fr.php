...
return [
    ...
    'auth.too_many_attempts'   => 'Trop de tentatives. Réessayez dans %d minute(s).',
    'auth.account_locked'      => 'Compte temporairement verrouillé après trop d\'échecs. Réessayez dans %d minute(s).',
    'auth.too_many_registrations' => 'Trop d\'inscriptions depuis cette adresse IP. Réessayez dans %d minute(s).',
    'auth.too_many_reset_requests' => 'Trop de demandes de réinitialisation. Réessayez dans %d minute(s).',
    ...
    'auth.google_error'             => 'La connexion via Google a échoué. Veuillez réessayer.',
    'auth.google_state_invalid'     => 'Requête invalide. Veuillez réessayer.',
    'auth.google_link_title'        => 'Relier votre compte Google',
    'auth.google_link_intro'        => 'Un compte Crabitan Bellevue existe déjà avec l\'adresse',
    ...
    'auth.google_link_cancel_info'  => 'Un compte existe déjà avec cette adresse email. Connectez-vous avec votre mot de passe, ou cliquez à nouveau sur « Continuer avec Google » pour associer votre compte.',
    ...
    'cart.browse'          => 'Voir notre boutique',
    ...
    'validation.password_lowercase' => 'Le mot de passe doit contenir au moins une lettre minuscule.',
    ...
    'account.password_same_as_current' => 'Le nouveau mot de passe doit être différent de l\'ancien.',
    ...
    'account.order_delivered_at' => 'Date de réception',
    ...
    'account.order_return_after_delivery' => 'Votre droit de rétractation (15 jours) sera disponible dès réception de votre commande.',
    'account.order_contact_subject'    => 'Demande d\'annulation — commande',
    'account.order_contact_link'       => 'Contacter le support',
    'account.order_return_notice'          => 'Pour toute demande de retour (carton d\'origine scellé, bouteilles non ouvertes, sous réserve de vérification à réception), contactez-nous.',
    ...
    'account.order_return_confirm'         => 'Souhaitez-vous exercer votre droit de rétractation ? Le retour doit être effectué en carton d\'origine scellé, bouteilles non ouvertes. Cette action est irréversible.',
    'account.order_return_requested'       => 'Votre demande de rétractation a été enregistrée. Nous reviendrons vers vous sous 48 h.',
    'account.order_refund_refused_notice'  => 'Votre demande de remboursement a été refusée. Si vous souhaitez contester cette décision, contactez-nous.',
    'account.order_return_expired'         => 'Le délai de rétractation de 15 jours après réception est dépassé. Pour tout problème avec votre commande, contactez-nous.',
    'account.order_return_no_date'         => 'La date de livraison de votre commande n\'a pas encore été enregistrée. Pour toute demande de retour, contactez-nous.',
    'account.order_return_slip_btn'            => 'Télécharger la fiche de retour',
    'account.order_return_in_progress_title'   => 'Retour en cours',
    'account.order_return_in_progress'         => 'Votre demande de retour est enregistrée. Si vous avez besoin d\'aide, vous pouvez contacter notre support.',
    ...
    'checkout.same_as_billing'        => 'Utiliser la même adresse pour la livraison',
    'checkout.same_as_delivery'       => 'Même adresse que la livraison',
    'checkout.beneficiary'            => 'Bénéficiaire',
    'checkout.error_zip_mainland'     => 'La livraison est disponible uniquement en France métropolitaine (hors Corse et DOM-TOM).',
    'checkout.new_address'            => 'Nouvelle adresse',
    'checkout.new_address_billing'    => 'Nouvelle adresse de facturation',
    'checkout.new_address_delivery'   => 'Nouvelle adresse de livraison',
    'checkout.payment_method'         => 'Mode de paiement',
    'checkout.payment_card'           => 'Carte bancaire',
    'checkout.payment_virement'       => 'Virement bancaire',
    'checkout.payment_cheque'         => 'Chèque',
    'checkout.payment_card_info'      => 'Paiement sécurisé par carte bancaire.',
    'checkout.payment_card_redirect'  => 'Vous serez redirigé(e) vers notre plateforme de paiement sécurisée après validation.',
    ...
    'checkout.summary_title'          => 'Récapitulatif',
    'checkout.removed_items_notice'   => 'Les articles suivants ont été retirés de votre panier car ils ne sont plus disponibles :',
    'checkout.unknown_product'        => 'Produit inconnu',
    'checkout.error_payment_method'   => 'Méthode de paiement invalide.',
    ...
    'checkout.thanks_message'         => 'Merci pour votre commande !',
    'checkout.order_reference'        => 'Référence commande :',
