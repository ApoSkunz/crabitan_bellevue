...
return [
    ...
    // Checkout — order tunnel
    'checkout.title'                  => 'Order checkout',
    'checkout.billing_address'        => 'Billing address',
    'checkout.delivery_address'       => 'Delivery address',
    'checkout.same_as_billing'        => 'Use the same address for delivery',
    'checkout.same_as_delivery'       => 'Same as delivery address',
    'checkout.beneficiary'            => 'Payable to',
    'checkout.error_zip_mainland'     => 'Delivery is only available to mainland France (excluding Corsica and overseas territories).',
    'checkout.new_address'            => 'New address',
    'checkout.new_address_billing'    => 'New billing address',
    'checkout.new_address_delivery'   => 'New delivery address',
    'checkout.payment_method'         => 'Payment method',
    'checkout.payment_card'           => 'Credit card',
    'checkout.payment_virement'       => 'Bank transfer',
    'checkout.payment_cheque'         => 'Cheque',
    'checkout.payment_card_info'      => 'Secure payment by credit card.',
    'checkout.payment_card_redirect'  => 'You will be redirected to our secure payment platform after checkout.',
    ...
    'checkout.removed_items_notice'   => 'The following items were removed from your cart as they are no longer available:',
    'checkout.unknown_product'        => 'Unknown product',
    'checkout.error_payment_method'   => 'Invalid payment method.',
    ...
    'checkout.thanks_message'         => 'Thank you for your order!',
